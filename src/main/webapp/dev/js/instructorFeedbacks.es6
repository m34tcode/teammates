/* global
import { StatusType } from './const.es6'; import { richTextEditorBuilder } from './richTextEditor.es6'; import { setStatusMessage } from './common/statusMessage.es6'; setStatusMessageToForm:false
